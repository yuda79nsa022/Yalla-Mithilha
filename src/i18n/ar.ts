...
export const ar = {
  ...
  'charades.checkout.deckLanguageTitle': 'أي عناوين تبي تلعب؟',
  'charades.checkout.deckLanguageArTitle': 'عربي بس',
  'charades.checkout.deckLanguageArSubtitle': 'مسرحيات ومسلسلات وأفلام كويتية وخليجية ومصرية',
  'charades.checkout.deckLanguageEnTitle': 'إنجليزي بس',
  'charades.checkout.deckLanguageEnSubtitle': 'أفلام هوليوود ومسلسلات أمريكية',
  'charades.checkout.deckLanguageMixedTitle': 'مزيج',
  'charades.checkout.deckLanguageMixedSubtitle': 'خليط عشوائي من العناوين العربية والإنجليزية',
  ...
  'charades.play.pointAwardedTo': 'نقطة لفريق {{team}}!',
