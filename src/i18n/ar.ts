...
export const ar = {
  ...
  'app.writeup':
    'يلا مثّلها لعبة تمثيل صامت — فريقين يمثّلون عناوين حقيقية بدون كلام والفريق الثاني يخمّن. اللي بتمثّلونه يتبع لغة الشاشة: العربي يعني مسرحيات ومسلسلات وأفلام كويتية وخليجية ومصرية؛ والإنجليزي يعني أفلام هوليوود ومسلسلات أمريكية وأغاني إنجليزية. عشرين جولة، يختارها السيرفر عشوائي كل مرة.',
