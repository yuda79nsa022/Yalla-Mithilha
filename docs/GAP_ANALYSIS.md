...
| Charades | IMPLEMENTED | `charades.test.ts` + full server test suite | Sign up → top up wallet → purchase → play (10 rounds, two teams) → complete, end to end, server-authoritative at every money-relevant step. |
